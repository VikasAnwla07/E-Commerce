...
function Checkout() {
    ...
    return ( 
      ...
      {addresses.map((address) => (
        ...
        <li key={address.phone} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-20">
      ...
      <div className="border-t border-gray-200 px-4 py-6 6 sm:px-6">
      <h1 className="text-4xl font-bold tracking-tight py-3 text-gray-900">Cart</h1>
