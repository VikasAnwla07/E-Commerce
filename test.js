...
// const categoreies = ([...new Set(products.map(product => product.category))]);
// console.log(categoreies.map(c=>({value:c,label:c.split('-').join(' '),checked:false})));

const brands = ([...new Set(products.map(product => product.brand))]);

console.log(brands.map(c=>({value:c,label:c,checked:false})));
